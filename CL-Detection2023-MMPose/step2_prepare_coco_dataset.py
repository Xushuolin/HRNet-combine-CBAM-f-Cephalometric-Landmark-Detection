...
if __name__ == '__main__':
    ...
    # data parameters
    parser.add_argument('--mha_file_path', type=str, default='E:\CL-Detection2023-MMPose\CL-detection2023/train_stack.mha')
    parser.add_argument('--train_gt_path', type=str, default='E:\CL-Detection2023-MMPose\CL-detection2023/train-gt.json')

    # save processed images dir path
    parser.add_argument('--image_save_dir', type=str, default='E:\CL-Detection2023-MMPose\CL-detection2023\MMPose')
